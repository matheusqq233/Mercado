...
public class MenuPrincipal extends javax.swing.JFrame implements InternalFrameListener{
   ...
   private void abrirCadFuncionario(){
    ...
    public void internalFrameClosed(InternalFrameEvent e) {
        ...
        if(e.getInternalFrame() instanceof GUICadProduto){
            flagGuiCadProduto = false;
         }else if (e.getInternalFrame() instanceof GUIManuProduto){
            flagGuiManuProduto = false;
         }else if(e.getInternalFrame() instanceof GUICadFuncionario){
            flagGuiCadFuncionario = false;
         }else if(e.getInternalFrame() instanceof GUIManuFuncionario){
